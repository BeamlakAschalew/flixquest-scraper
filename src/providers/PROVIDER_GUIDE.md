...
| `vuflix`          | Broad movie/TV multi-source catalog including Sigma, 4K, Upsilon and more | 🌐 Original/🇬🇧 EN; optional 🇮🇳 HI and 🇩🇪 DE tracks vary by backend                         | Explicit **360p, 480p, 720p, 1080p, 2160p/4K** plus adaptive HLS observed                         | Fetches Vuflix's live provider catalog and queries every advertised backend, including manual-only entries. Individual failures are isolated; quality, candidate, and language-switch URLs are retained. |
